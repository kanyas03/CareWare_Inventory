...
const StockAlert = () => {
  ...
  return (
    ...
    //                   <button className="bg-indigo-950 text-white px-4 py-1 rounded">Update</button>
    //                 </Link>
    //               </td>
    //             </tr>
    //           ))}
    ...
    //         <thead>
    //           <tr className="bg-gray-800 text-white">
    //             <th className="border p-2 border-gray-600">Product Name</th>
    //             <th className="border p-2 border-gray-600">Quantity</th>
    //             <th className="border p-2 border-gray-600">Action</th>
    //           </tr>
    //         </thead>
    //         <tbody>
