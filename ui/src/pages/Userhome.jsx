...
//       <div className="bg-zinc-400 flex md:w-[998px] w-[250px] rounded-2xl drop-shadow-2xl space-x-4 shadow-gray-950 md:mt-10 mt-5 md:mx-32 p-4">
...
const UserHome = () => {
  ...
  return (
    ...
    //   <div className="flex justify-center mt-6 space-x-4">
    //     <button 
    //       className={`bg-indigo-950 md:w-[250px] w-[180px] text-white font-bold rounded-2xl ml-10 ${selectedCategory === "All" ? "bg-indigo-700" : "bg-gray-300"}`}
    //       onClick={() => setSelectedCategory("All")}
    //     >
    //       All
    //     </button>
    //     <button 
    //       className={`bg-indigo-950 md:w-[250px] w-[180px] text-white font-bold rounded-2xl ml-10 ${selectedCategory === "Disposable" ? "bg-indigo-700" : "bg-gray-300"}`}
    //       onClick={() => setSelectedCategory("Disposable")}
    //     >
    //       Disposable
    //     </button>
    //     <button 
    //       className={`bg-indigo-950 md:w-[250px] w-[180px] text-white font-bold rounded-2xl ml-10 ${selectedCategory === "Non-Disposable" ? "bg-indigo-700" : "bg-gray-300"}`}
    //       onClick={() => setSelectedCategory("Non-Disposable")}
    //     >
    //       Non-disposable
    //     </button>
